...
<header class="container-fluid">
	<div class="container clearfix p-2">
		<a href="index" class="float-start"><img src="images/the.gif"
			alt="로고" class="img-fluid" width="250"></a>
...
<nav class="navbar bg-dark navbar-expand-sm">
	<ul class="navbar-nav container justify-content-start">
		<li class="mx-5 nav-item"><a class="nav-link text-white"
			href="index.html">메인페이지</a></li>
		<li class="mx-5 nav-item"><a class="nav-link text-white"
			href="mypage.html">마이페이지</a></li>
		<li class="mx-5 nav-item"><a class="nav-link text-white"
			href="post.html?category=1">공지사항</a></li>
		<li class="mx-5 nav-item dropdown"><a
